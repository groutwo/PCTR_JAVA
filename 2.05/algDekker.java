...
class algDekker {
    ...
    /* Process qr wants to enter critical section */    
    ...
    class P extends Thread
    {
        public void run()
        {
            while (true)
            {
                ...
                Thread.yield();
                /* Critical section */
                System.out.println("P: Number of processes in critical section: "+ inCS);
                inCS--;
                turn = 2;
                wantp = false;
            }
    ...
    class Q extends Thread
    {
        public void run()
        {
            while (true)
            {
                ...
                Thread.yield();
                /* Critical section */
                System.out.println("Q: Number of processes in critical section: "+ inCS);
                inCS--;
                turn = 3;
                wantq = false;
            }
    ...
    class R extends Thread
    {
        public void run()
        {
            while (true)
            {
                ...
                Thread.yield();
                /* Critical section */
                System.out.println("R: Number of processes in critical section: "+ inCS);
                inCS--;
                turn = 1;
                wantr = false;
            }
    ...
    algDekker() 
    {
        Thread p = new P();	Thread q = new Q();	Thread r = new R();
